...
namespace AndreAirlineApi2.Controllers
{
    ...
    public class PassageirosController : ControllerBase
    {
        ...
        public PassageirosController(AndreAirlineApi2Context context)
        {
            _context = context;
        }
        ...
        {
            var endereco = _context.Endereco.Find(passageiro.Endereco.Id);
            if (endereco == null)
                return BadRequest("Endereço não foi Localizado.");
